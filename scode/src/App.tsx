...
function App() {
  ...
  return (
    <div className="App">
      <header className="p-3 bg-slate-700 text-white sticky top-0">
        <div>
          <img className='w-12 block sm:hidden' src={logo} alt="scode-logo" />
          <h1 className='text-2xl font-light tracking-[15px] hidden sm:block'>SCode</h1>
        </div>
        <nav className='flex gap-2 py-2 text-gray-300'>
          <Link className='hover:text-gray-100' to={'/'}>Home</Link>
          <Link className='hover:text-gray-100' to={'/doc'}>Documentation</Link>
          <Link className='hover:text-gray-100' to={'/encrypt'}>Encrypt</Link>
          <Link className='hover:text-gray-100' to={'/decrypt'}>Decrypt</Link>
        </nav>
      </header>
      <main>
        <Routes>
      ...
      <footer className="bg-gray-900">
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
              <div
              className="mt-0 sm:flex sm:items-center sm:justify-between"
              >
              ...
              <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
                  <li>
                  <a
                      href="https://www.facebook.com/mike.pascal.967"
                      rel="noreferrer"
                      target="_blank"
                  ...
                  <li>
                  <a
                      href="https://www.instagram.com/mike9_73/"
                      rel="noreferrer"
                      target="_blank"
                      className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
                  >
                  ...
                  <li>
                  <a
                      href="https://twitter.com/IlSognatore973"
                      rel="noreferrer"
                      target="_blank"
                      className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
                  >
