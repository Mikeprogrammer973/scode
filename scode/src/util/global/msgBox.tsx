...
{
    return(
        prms.visible ? <section style={{backgroundColor: "rgb(0, 0, 0, 0.3)"}} className="w-full h-full fixed top-0 left-0 flex items-center justify-center">
        <div className="bg-slate-100 inline-block p-4 rounded-xl shadow-lg max-w-[90%] max-h-[90%] overflow-y-scroll">
